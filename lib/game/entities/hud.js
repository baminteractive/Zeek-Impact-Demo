...
.defines(function(){
	...
	EntityHud = ig.Entity.extend({
		...
		// Assure that even if the game has gravity applied to it, the HUD entity does not
		gravityFactor: 0,

		healthAmountPerContainer: 10,

		// Make sure that the HUD doesn't interfere with any other entities
		...
		// Handles drawing the player's health bar
		drawHealth: function() {
		...
		// Handles drawing the player's current items
